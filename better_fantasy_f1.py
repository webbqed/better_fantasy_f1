...
class Driver:
    ...
    def __init__(self, full_name, driver_number, team_name, win_prob=None, dnf_prob=None, expected_finish=None, theta=None, sim_results=None, sim_points=None, sim_mean=None, sim_std=None, price=None):
        """
...
def points_from_finishes(positions, point_values, dnf_value):
    """
    Convert positions to points based on the given point values and DNF value.
    """
...
def price_from_stats(mean, std, risk_discount_factor=0.1, K=5.0):
    ...
    - risk_discount_factor: discount factor for risk
    - K: scale factor
    """
...
if __name__ == "__main__":
    ...
    for i, driver in enumerate(current_drivers):
        ...
        driver.sim_mean = np.mean(driver.sim_points)
